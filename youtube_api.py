...
class YoutubeScrapeResult(BaseModel):
    ...
    detailedMetadataSnippets: list[YoutubedetailedMetadataSnippetItem] | None
    ...
    def to_youtube_scrapping_result(self) -> YoutubeScrappedVideo:
        return YoutubeScrappedVideo(
            ...
            description=self.detailedMetadataSnippets[0].snippetText.runs[0].text,
        )
